...
audio_datasets = np.reshape(audio_datasets, (59493,5))
scaler2.fit(audio_datasets)
audio_datasets = scaler2.fit_transform(audio_datasets)
train_size = 40000 # need to see len(audio first)
...
max_len = 20000
# train_padded = pad_sequences(train_datas , maxlen = max_length , truncating = "post" , padding = "post")
# test_padded = pad_sequences(test_datas , maxlen = max_length , truncating = "post" , padding = "post")
# train_labels = np.array(train_labels)
# test_labels = np.array(test_labels)
embedding_dim = 8 #
keypoint_size = 3*46*432
model = Sequential([
