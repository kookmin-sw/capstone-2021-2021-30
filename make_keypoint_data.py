...
def make_keypoint_data():
    motions = ["left_shoulder", "left_elbow", "right_shoulder", "right_elbow", "left_wrist", "left_thumb_cmc",
               ...
               "left_pinky_tip", "right_wrist", "right_thumb_cmc", "right_thumb_mcp", "right_thumb_ip",
               "right_thumb_tip",
               "right_index_finger_mcp", "right_index_finger_pip", "right_index_finger_dip", "right_index_finger_tip",
               "right_middle_finger_mcp", "right_middle_finger_pip", "right_middle_finger_dip",
    ...
    for lst in res:
        for motion in motions:
            ...
            lst.append(datas[motion]["x"][idx])
            lst.append(datas[motion]["y"][idx])
            lst.append(datas[motion]["z"][idx])
        i += 1
